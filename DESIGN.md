---
name: Raycast Premium App Store
colors:
  surface: '#141313'
  surface-dim: '#141313'
  ...
  primary: '#c7c6c9'
  on-primary: '#2f3033'
  primary-container: '#07080a'
  on-primary-container: '#78787b'
  inverse-primary: '#5e5e61'
  secondary: '#ffb3af'
  on-secondary: '#68000e'
  secondary-container: '#93111e'
  on-secondary-container: '#ff9e9a'
  tertiary: '#cec5c0'
  on-tertiary: '#342f2c'
  tertiary-container: '#0a0705'
  on-tertiary-container: '#7e7773'
  error: '#ffb4ab'
  on-error: '#690005'
  ...
  on-secondary-fixed-variant: '#8f0d1c'
  ...
  brand-red: '#FF6363'
  interactive-blue: '#55b3ff'
  success-green: '#5fc992'
  warning-yellow: '#ffbc33'
  surface-100: '#101111'
  card-surface: '#1b1c1e'
  text-primary: '#f9f9f9'
  ...
  key-gradient-start: '#121212'
  key-gradient-end: '#0d0d0d'
typography:
  display-hero:
    fontFamily: Inter
    fontSize: 64px
